...
@section('content')
<form method="POST" enctype="multipart/form-data" id="upload-file" action="{{ url('/dokumen/store') }}">
  @csrf
...
<div class="card card-primary">
  <div class="card-header">
    <h3 class="card-title">Upload Dokumen Informasi</h3>
  </div>
  <div class="card-body">
    <div class="form-row">
      <div class="col-md-12 mb-12">
        <label for="exampleInputEmail1">Judul Dokumen</label>
          <input type="text" name="judul" class="form-control" id="exampleInputEmail1" placeholder="Profil Desa">
      </div>
      ...
      <div class="col-md-1 mb-1">
        ...
        <input type="text" name="tahun" class="form-control" id="exampleInputEmail1" placeholder="2021">
      </div>
