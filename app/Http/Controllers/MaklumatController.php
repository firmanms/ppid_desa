...
class MaklumatController extends Controller
{
    ...
    {
        $liststruktur= Maklumat::where("id","1")->get();
        return view('admin.maklumat.maklumat',['liststruktur'=>$liststruktur]);
    }
    ...
    public function edit(Maklumat $sop)
    {
        $sop= Maklumat::orderby("id","desc")->first();
        
        return view('admin.maklumat.maklumatedit',compact('sop','sop'));
    }
    public function update(Request $request, Maklumat $sop)
    {
    ...
    //get data Blog by ID
    $sop = Maklumat::findOrFail($sop->id);
